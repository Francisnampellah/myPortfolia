        ...
        <div className="h-1/2 lg:h-full lg:w-1/2 flex items-center justify-center text-6xl">
          <div>
           ...
           {/* FORM CONTAINER */}
            ...
            <button type="button" class="text-white   font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2  p-4 text-white bg-blue-400/100 focus:bg-blue-700/60 rounded-lg shadow-md border border-slate-400/100 ">Submit</button>
            </div>
